...
No comando acima estamos **criando um certificado** para o nosso usuário, utilizando a **chave privada** que criamos anteriormente. O parametro **req** indica que queremos criar um certificado, o parâmetro **-key** indica o nome do arquivo da chave privada que queremos utilizar, o parametro **-out** indica o nome do arquivo que queremos salvar o certificado, e o parametro **-subj** indica o nome do usuário que queremos criar.
